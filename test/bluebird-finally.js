...
Promise.prototype.thenCatch = thenCatch
...
describe("bluebird's promise", function(){
  ...
  it("should produce desired result .thenCatch() expect error object ", function(done){
  ...
  it("should produce desired result .thenCatch() expect equal false", function(done){
